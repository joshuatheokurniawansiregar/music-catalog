...
import (
	...
	tracks "github.com/joshuatheokurniawansiregar/music-catalog/external/spotify/model/tracks"
...
func (m *Mockservice) Search(ctx context.Context, query string, pageSize, pageIndex int) (*tracks.SearchResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Search", ctx, query, pageSize, pageIndex)
	ret0, _ := ret[0].(*tracks.SearchResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
