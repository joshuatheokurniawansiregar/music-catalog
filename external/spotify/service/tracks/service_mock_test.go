...
import (
	...
	tracks "github.com/joshuatheokurniawansiregar/music-catalog/external/spotify/repository/tracks"
...
func (m *MockspotifyOutbound) Search(ctx context.Context, query string, limit, offset int) (*tracks.SpotifySearchResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Search", ctx, query, limit, offset)
	ret0, _ := ret[0].(*tracks.SpotifySearchResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
